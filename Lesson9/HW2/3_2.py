...
# конструктор це просто функція __init__ , яка буде викликатися в момент виклику класу.
    def __init__(self, model, engine_type, color1): # __init__(self):  це обовязковий елементк конструктора
...
# визначимо метод всередині класу Car
    ...
    def color1(self): #1 колір автомобіля
        print(f'The color of the car is {self.color1}')
...
car = Truck('MAN', 'V-12', 'yellow')

car.move()
car.offload()
car.color1()

car2 = Car('audi', 'v-6', 'purple')
