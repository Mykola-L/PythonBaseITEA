...
# зберігаємо файл в поточній директорії
    ...
    path = entry2.get()
    # print(r)
    if path != "": # якщо користувач ввів директорію, зберігає в директорію
        a = path # a = шлях до директорії
    else:
        a = "./"

    if entry3.get() != "":  # якщо користувач ввів директорію, зберігає в директорію
